...
import static wal.model.Account_.historyList;
...
public class DepositeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session != null) {
            if (money != null && money.length() > 0) {
                ...
                if (ac != null) {
                    ...
                    try {
                        ...
                        History his = new History(hisid + 1, ac, "deposite", Integer.valueOf(money), new Date(), result);
                        hisCtrl.create(his);
                        ...
                        Logger.getLogger(DepositeServlet.class.getName()).log(Level.SEVERE, null, ex);
            ...
            getServletContext().getRequestDispatcher("/Deposite.jsp").forward(request, response);
        }
